  ...
  return (
    <>
      ...
      <div id="contenido-proyectos">
        <div id="contenido-proyectos-container" className="text-white">
          <img src={circleLeft} alt="Vectores" />
          <img src={arrows} alt="Vectores" />
    ...
    <div id="contenido-investigacion">
        <div id="contenido-investigacion-container" className="text-white">
          <img src={circleRight} alt="Vectores" />
          <img src={arrows} alt="Vectores" />
    ...
    <div id="contenido-mayores">
        <div id="contenido-mayores-container" className="text-white">
          ...
          <ul id="contenido-mayores-list" className="pt-4">
            ...
            <p>Podés descargarlo <a href="https://drive.google.com/file/d/1dmxPOtJQmYJE6BkJ0FivsNyQE7_TE_bs/view" rel="noreferrer" target='_blank' className="black-link">aquí</a></p>
            <p>¿Te gustaría sumar nuevos términos? Hacé click <a href="https://docs.google.com/forms/d/e/1FAIpQLSdAas-tPm1XItreBzn9uiW35jP_38S2m8-Kw_Y-jbvAg9_-FQ/viewform" target='_blank' rel="noreferrer" className="black-link">aquí</a></p>
    ...
    <div id="contenido-editorial">
        <div id="contenido-editorial-container" className="text-white">
          ...
          <ul id="contenido-editorial-list" className="pt-4">
            ...
            <p>¡Escuchalo <a href="https://open.spotify.com/show/7C9qkB1y83GGSaYNu0nqPc" target='_blank' rel="noreferrer" className="black-link">aquí</a> !</p>
          </ul>
        </div>
      </div>
    </>
