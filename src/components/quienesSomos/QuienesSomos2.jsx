...
export default function QuienesSomos2(){
  return(
    <div>
      ...
      <QuienesSomos2Cards charge="Coordinación general" name="Ariadna - Sol"/>
      <QuienesSomos2Cards charge="Proyectos" name="Marce - Rodri"/>
      <QuienesSomos2Cards charge="Investigación" name="Agostina - Lucia"/>
      <QuienesSomos2Cards charge="Adultos mayores" name="Paz"/>
      <QuienesSomos2Cards charge="Recursos humanos" name="Tamara"/>
      <QuienesSomos2Cards charge="Comunicación" name="Josefina - Melina"/>
